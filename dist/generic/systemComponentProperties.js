...
var PAPER_UTILITIES = __spreadArray(__spreadArray([], systemStyleProperties_1.BORDER, true), systemStyleProperties_1.COLOR, true);
...
var CARD_UTILITIES = __spreadArray([], systemStyleProperties_1.FLEXBOX_CONTAINER, true);
...
var CARD_CONTENT_UTILITIES = __spreadArray(__spreadArray(__spreadArray([], systemStyleProperties_1.TEXT, true), systemStyleProperties_1.FLEXBOX_ITEM, true), systemStyleProperties_1.FLEXBOX_CONTAINER, true);
...
var CARD_ACTIONS = [['spacing', 'c-cardActions--spacing'], ['gap', 'c-dialogActions--gap'], ['disableGap', 'c-cardActions--disableGap']];
var CARD_ACTIONS_DEFAULTS = {
    gap: 2,
    spacing: 1,
    disableGap: false
};
var CARD_ACTIONS_UTILITIES = __spreadArray([], systemStyleProperties_1.FLEXBOX_CONTAINER, true);
...
var CARD_ACTION_AREA_UTILITIES = __spreadArray([], systemStyleProperties_1.FLEXBOX_CONTAINER, true);
...
var CARD_MEDIA_UTILITIES = __spreadArray([], systemStyleProperties_1.BORDER, true);
...
var AVATAR_UTILITIES = __spreadArray([], systemStyleProperties_1.COLOR, true);
...
var DIALOG_ACTIONS_UTILITIES = __spreadArray([], systemStyleProperties_1.FLEXBOX_CONTAINER, true);
...
var DIALOG_CONTENT_UTILITIES = __spreadArray([], systemStyleProperties_1.FLEXBOX_CONTAINER, true);
...
var DIALOG_TITLE_UTILITIES = __spreadArray([], systemStyleProperties_1.FLEXBOX_CONTAINER, true);
